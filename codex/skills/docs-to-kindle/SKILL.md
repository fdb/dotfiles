---
name: docs-to-kindle
description: Scrape a documentation website and convert it to .epub and .azw3 for Kindle. Use when the user asks to turn docs, guides, or a documentation site into an ebook for Kindle or EPUB readers.
---
...
**Target URL:** Use the URL from the user request.

## Process

### 1. Discover all pages

Navigate to the docs URL using browser automation or Playwright and inspect the page structure to extract the full sidebar/navigation structure. Get every documentation page URL. If the sidebar has collapsed/expandable sections, use page JavaScript evaluation to expand them all and extract links:
